...
def scan_for_profanities(directory, log_file, excluded_words_file=None):
    ...
    with open(log_file, 'w') as f:
        for root, dirs, files in os.walk(directory):
            for file in files:
                if file.endswith('.md'):  # Adjust the file extension based on your file types
...
scan_for_profanities("../content/", "../profanity_log.txt", excluded_words_file="../.profanity_ignore.yml")  # Replace "your_code_directory/" with the appropriate directory path, provide the desired log file name, and specify the path to the excluded words file