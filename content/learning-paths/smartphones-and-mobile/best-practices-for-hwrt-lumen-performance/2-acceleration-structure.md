...
### TLAS 
TLAS only stores instancing data of BLAS, for example, transform data of each instance. TLAS dosen't store any geometry data, it only store which BLAS is related. By this way, the hardware can save memory usage by just storing one geometry data for many duplicated objects.
