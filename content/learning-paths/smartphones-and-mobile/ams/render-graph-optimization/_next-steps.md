---
next_step_guidance: If you haven't already done so, please read [the main Frame Advisor learning path](/learning-paths/smartphones-and-mobile/ams/fa). Much more information will be found in [the Frame Advisor user guide](https://developer.arm.com/documentation/102693/latest/).

recommended_path: /learning-paths/smartphones-and-mobile/ams/fa/
