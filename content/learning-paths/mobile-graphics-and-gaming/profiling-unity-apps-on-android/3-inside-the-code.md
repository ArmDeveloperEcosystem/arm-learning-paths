...
For the purpose of demonstrating the tools introduced in this Learning Path, you are going to take advantage of the three different modes that are available in the sample code.
...
In *Assets/BurstNeonCollisions/CollisionCalculationScript.cs*. Edit line 66 to set _codeMode_ to _Mode.Plain_
