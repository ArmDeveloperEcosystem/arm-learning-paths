...
Append Cmake ext and c ext images
...
Under the **Vulkan Layers Availble** tab, add the path to your `Emulation layer` folder that can be found in the site packages of your venv folder select the bin folder.
