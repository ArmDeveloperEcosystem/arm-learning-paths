---
title: Prepare the Android command-line tools for Vision Chat
description: Install and verify the Android command-line tools and SDK packages needed to build Vision Chat.
weight: 2
...
The [Arm AI Portal](https://developer.arm.com/ai) is a catalog of AI models across different runtimes, use cases, and profiles that are optimized for different Arm-based targets. The AI Portal provides benchmarking and compatibility data, code examples, and deployment methods.

You'll use an example application called Vision Chat to run a Qwen3-VL vision-language model from the Arm AI Portal on an Arm-based Android device.
...
test -d "$ANDROID_HOME/ndk/27.2.12479018"
...
The final four checks return no output on macOS or Linux when the directories exist. On Windows, all four checks should return `True`.

## What you've accomplished and what's next

You've now installed the Android command-line tools and verified the required SDK packages.

Next, you'll connect an Arm-based Android phone and build Vision Chat.
