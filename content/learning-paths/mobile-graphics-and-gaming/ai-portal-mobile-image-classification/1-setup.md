---
title: Set up the Android command-line tools for Photo Insight
description: Install and verify the Android command-line tools and SDK packages needed to build Photo Insight.
weight: 2
