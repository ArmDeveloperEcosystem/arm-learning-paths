---
title: Analyze mesh geometry with Content Metrics on Frame Advisor
...
4. Next, sort the **Content Metrics** table by lowest vertex shading efficiency (VSE). This identifies objects that shade more indices than they use. Gaps in the index stream can cause unused indices to be shaded. Poor reuse locality can cause indices to be shaded multiple times.
