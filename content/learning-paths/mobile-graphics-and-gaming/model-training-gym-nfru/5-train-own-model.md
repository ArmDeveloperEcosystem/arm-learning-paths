...
## Beyond NFRU: working with your own model
...
Each use case directory must contain an `__init__.py` file. To understand how the configuration files work, revisit the example notebooks for NFRU in previous sections.
...
Your custom model will go through the same pipeline as NFRU: training, quantization, evaluation, and export to `.vgf` format.
