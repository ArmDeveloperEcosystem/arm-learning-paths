...
The Unity Profiler will help you analyze the performance of your app to see why it's not running smoothly. The tool allows you to analyze CPU, graphics and memory usage across the different areas of the app including general scripting, physics and audio.

You can activate the profiler both in the editor and when you're running on a connected device. It will collect performance data from every frame in a useful timeline.

You can also insert statements into your code to gather custom data about the app. More about this later.

Although you won't get accurate data for your target device, it is useful to run the Profiler in the editor so you can quickly get an overview of how it works.

After this Learning Path, read the [Profiler overview](https://docs.unity3d.com/Manual/Profiler.html) on the Unity web site.
...
1. While the app is running, you can open the Profiler. Select menu option _Window->Analysis->Profiler_.
