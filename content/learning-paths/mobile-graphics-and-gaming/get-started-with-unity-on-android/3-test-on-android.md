...
You're going to build the sample for Android. To do so takes just a few steps and they are all achieved from the _Build Settings_ window.

1. First off, you need to switch the project to _Android_.
...
1. In your project the platform labelled _Active_ will be your machine's operating systems (Windows, Mac or Linux). Since you are developing an Android app you must rebuild for Android.
...
1. In the screenshot, you can see that the SampleScene is already included in the build and preselected as the first scene to load.
...
To deploy to your Android device, you will need to enable the _Android Developer Options_ and _USB Debugging_ on your device:
