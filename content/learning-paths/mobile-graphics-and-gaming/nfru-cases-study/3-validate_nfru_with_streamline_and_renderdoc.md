...
| --- | --- |
| `InterpolatedRT` | Generated frame target before it's copied or presented. In `ARM_NFRU_POSTPROCESS`, the target is typically the texture bound behind `rw_output`. |
