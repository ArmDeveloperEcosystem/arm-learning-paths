---
title: Prepare the Android command-line tools for building Scene Detector
description: Install and verify the Android command-line tools and SDK packages needed to build Scene Detector.
weight: 2
...
The following platform-specific commands download Google's [Android SDK Command-Line Tools](https://developer.android.com/tools), verify the pinned archive checksum, and place the tools under `ANDROID_HOME`:
