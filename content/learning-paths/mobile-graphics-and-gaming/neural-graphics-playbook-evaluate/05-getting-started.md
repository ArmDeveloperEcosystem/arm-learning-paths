...
NFRU is a good entry point for evaluating neural graphics. The setup is designed to feel familiar. You integrate the plugin, enable it in your project, and evaluate it the way you would any other rendering feature.
