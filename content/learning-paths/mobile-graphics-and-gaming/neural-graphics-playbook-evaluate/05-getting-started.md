...
NFRU is a good entry point to start evaluating neural graphics. The setup is designed to feel familiar. You integrate the plugin, enable it in your project, and evaluate it like you would any other rendering feature.
...
If you’re curious about what that looks like in practice, we’re sharing more detail in the blog below, which walks through how we approached lighting at scale and how NSSD fits into that setup:
...
That should give you a clearer picture of what’s involved, and whether it’s something you want to explore further.

At this stage, NSSD is best approached as an experiment rather than a feature. It’s something you evaluate if you’re interested in pushing beyond what’s currently possible with traditional techniques—particularly around dynamic lighting—but it comes with a higher barrier to entry.
