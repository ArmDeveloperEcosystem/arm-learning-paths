...
[SmolVLA](https://arxiv.org/pdf/2506.01844) is a lightweight vision-language-action model with around 450 million parameters. The model takes camera images, a language instruction, and the robot state as inputs. It then outputs a sequence of robot actions.
...
The model stages in the ExecuTorch conversion pipeline are the following:
