...
Install GCC for your Arm Linux distribution. Install using the steps [here](/install-guides/gcc/#native).
...
To benchmark the compression efficiency and performance of `x265`, you will need a set of video streams to run the codec on. In this learnign path will use the video files from Google YouTube UGC data set with different resolutions from the link [here](https://console.cloud.google.com/storage/browser/ugc-dataset/original_videos/Sports)
