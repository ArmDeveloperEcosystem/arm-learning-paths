...
When you use the skill to run the Code Hotspots recipe, expect your AI assistant to propose a second pass with a characterizing recipe such as CPU Microarchitecture, Instruction Mix, or Memory Access to explain why the hotspot is hot. Let the assistant run that pass before deciding whether a cost is irreducible.
