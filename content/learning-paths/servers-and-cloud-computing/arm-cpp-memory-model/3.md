...
Start an Arm-based cloud instance. This example uses the Arm AGI CPU running Ubuntu 24.04 LTS, but you can follow along with other Arm-based processors running linux.
