...
## Before you begin
The instructions in this Learning Path are for any Arm server running Ubuntu 22.04 LTS. For this example, you will need an Arm server instance with at least 4 cores and 8GB of RAM. The instructions have been tested on AWS Graviton3 (c7g) instances.
