...
* Also, add the following tag: `allow-qdrant` so this virtual machine matches the firewall rule you created in the previous section.
...
Your virtual machine is now ready to host Qdrant.
