...
In the tabs panel at the bottom, click the plus (`+`) and add other views. Here there are multiple other views available such as Register View, Memory View, and others.
