...
![Screenshot of VM instances list showing the SSH button in the Connect column#center](images/gcp-ssh.png "Invoke a SSH session into your running VM instance")
