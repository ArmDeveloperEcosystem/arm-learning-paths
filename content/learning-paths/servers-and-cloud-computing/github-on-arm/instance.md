---
title: Create Google Axion C4A Arm VM
weight: 3
...
This guide walks you through provisioning **Google Axion C4A Arm VM** on GCP with the **c4a-standard-4 (4 vCPUs, 16 GB Memory)** machine type, using the **Google Cloud Console**. 

If you are new to Google Cloud, it is recommended to follow the [GCP Quickstart Guide to Create a VM](https://cloud.google.com/compute/docs/instances/create-start-instance).
