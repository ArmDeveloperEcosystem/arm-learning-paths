...
For more detailed steps to create an instance, see the [Deploy an Arm-based virtual machine on Azure with Cobalt 100 Learning Path](/learning-paths/servers-and-cloud-computing/cobalt/).
