...
![text#center](images/streamline_capture.png "Figure 5. Streamline Capture")
...
![text#center](images/streamline_capture_image.png "Figure 6. Streamline config")
...
![text#center](images/annotation_marker_1.png "Figure 7. Annotation Marker")
...
![text#center](images/annotation_marker_2.png "Figure 8. Annotation Marker 2")
...
![text#center](images/annotation_marker_prefill.png "Figure 9. Annotation Marker Prefill and Decode stage")
...
![text#center](images/annotation_pmu_stall.png "Figure 10. Annotation PMU stall cycle")
...
![text#center](images/annotation_prefill_call_stack.png "Figure 11. Call stack")

In the ‘Functions’ view of Streamline, we can see the percentage of running time of functions.
![text#center](images/annotation_prefill_functions.png "Figure 12. Functions")
...
* The computation (GEMM and GEMV) of Q, K, V vectors and most of FFN layers have weights with Q4_0 data type, and the input activations are with FP32 data type. The computation is forwarded to KleidiAI trait by ggml_cpu_extra_compute_forward. KleidiAI ukernels implemented with NEON Dotprod and I8MM vector instructions are used to accelerate the computation.
    ...
    ![text#center](images/Prefill_only.png "Figure 13. Prefill only")
    ...
    ![text#center](images/Decode_only.png "Figure 14. Decode only")
