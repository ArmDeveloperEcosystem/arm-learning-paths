...
prerequisites:
    - An Arm Neoverse-based server running Linux, such as an AGI CPU platform (bare-metal or cloud bare-metal access is preferred for hardware performance counters)
