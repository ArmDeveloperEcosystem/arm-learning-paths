...
Your Azure Cobalt 100 Arm64 virtual machine is now ready. Next, you will install MinIO to set up S3-compatible object storage and begin storing and managing data on the virtual machine.
