...
2. Copy and paste this text into your terminal to create the `requirements.txt` file:
...
```bash
chmod +x rexec_sweet.py
```
6. Make sure the instances you created in the previous section are running.  If not, start them now.
