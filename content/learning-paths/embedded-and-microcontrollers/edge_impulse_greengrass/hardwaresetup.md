...
If you don't have any of these physical hardware boards, use the AWS EC2 option. It creates an Arm-based virtual machine in the cloud that behaves like a local edge device, so you can complete every step in this Learning Path without dedicated hardware.
