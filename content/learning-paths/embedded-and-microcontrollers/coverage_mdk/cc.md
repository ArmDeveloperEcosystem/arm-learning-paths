...
A code coverage report highlights which areas of your code base your tests have run through. A common use case is to verify that all cases of a C switch statement have been triggered.

You can perform code coverage in MDK with the provided Fixed Virtual Platforms (FVPs) or with real target hardware. This Learning Path uses FVPs.
