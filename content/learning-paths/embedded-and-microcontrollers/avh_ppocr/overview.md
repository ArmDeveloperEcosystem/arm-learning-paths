...
![Sample image showing the word GREENGUARD in uppercase letters on a textured background, demonstrating a typical OCR text recognition input used for testing English character recognition models#center](./figure1.png "Example of English text recognition")
