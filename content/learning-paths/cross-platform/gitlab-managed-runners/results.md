...
{{%notice Note%}}
Gitlab offers a lot of documentions on how to create pipelines that fits different needs and also offer common templates for them as well. You can access them from [Use CI/CD to build your application](https://docs.gitlab.com/topics/build_your_application/) page.
{{%/notice%}}
