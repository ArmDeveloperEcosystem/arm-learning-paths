...
This result indicates the RPi5 device (Armv8) does not report PAC and BTI capabilities and is potentially vulnerable to control-flow attacks that PAC/BTI inhibits on Armv9.
