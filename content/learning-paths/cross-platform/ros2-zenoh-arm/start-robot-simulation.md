...
![Navigation2 terminal output showing managed nodes active while the navigation stack starts in the robot container.#center](images/nav2-successfully-running.png)
