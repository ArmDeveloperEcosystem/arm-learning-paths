...
![Top output showing Gazebo and RViz as the highest-CPU processes in the ROS 2 simulation. The screenshot establishes the workload baseline before shared memory is enabled.#center](images/just-top.png)
