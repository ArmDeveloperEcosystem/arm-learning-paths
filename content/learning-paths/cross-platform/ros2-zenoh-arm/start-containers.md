...
![Browser showing the Ubuntu desktop running inside the robot container through noVNC, confirming that the container desktop is accessible.#center](images/robot-desktop.png)
