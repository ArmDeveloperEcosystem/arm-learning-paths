...
generated_summary_faq:
  ...
  summary: >-
    Use Arm IP Explorer to run built-in and custom software on cloud-hosted simulation platforms for
    Arm Cortex-M processors. You launch an example to collect cycle-accurate results, edit a marked C
    source region to create a benchmark, and build a `.tgz` archive on Linux. You then upload the
  ...
  - question: I don’t see my Cortex-M0 or Cortex-M7 instances under Simulate Processors—what should
      I check?
    answer: >-
      Confirm that you are logged in to IP Explorer and created the instances in the earlier step.
  ...
  - question: Which compiler option should I choose when starting the simulation run?
    answer: >-
      Select AC6 (Arm Compiler for Embedded), as shown in the example steps. Use the same compiler
