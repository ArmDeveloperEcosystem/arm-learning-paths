...
generated_summary_faq:
  ...
  summary: >-
    Explore memory latency with a small C workload on Arm Linux. You modify the application in stages:
    add an allocator for locality, adjust structure layout and cache alignment, and add prefetching
    to bring data closer to the CPU. You build and run each version, compare relative runtime trends,
