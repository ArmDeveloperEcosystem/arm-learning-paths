...
The CDK CLI supports different operating systems and the Arm architecture. In this guide, you'll learn how to install the CDK CLI and verify that the CLI installation was successful. 
