...
To learn more, see the [Run and benchmark BitNet-2B inference on Arm CPUs with Litespark-Inference](/learning-paths/cross-platform/litespark-inference/) Learning Path. 
