...
Socrates is available as a component of a [Hardware Success Kit](https://www.arm.com/products/development-tools/success-kits).

{{% notice Video Tutorial %}}
In addition to this install guide, a [tutorial video](socrates_1_install.mp4) is also available.
{{% /notice %}}
