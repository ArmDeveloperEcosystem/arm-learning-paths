...
prerequisites. Don't infer. Unless there is a glaring technical issue, focus entirely on editorial fixes. Rely on the Learning Path as the source of technical truth. 
